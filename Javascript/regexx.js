...
const isValidEmail = /^[\w.-]+@[\w.-]+\.\w{2,}$/.test(emailid);
...
const text2 = "Visit https://openai.com and http://example.org now!";
...
const dates = "2025-07-31";
const isValidDate = /^\d{4}-\d{2}-\d{2}$/.test(dates);
